...
| `packages/app-executor` |     3 |          662 | Desktop/hosted Node sidecar worker, code-runner require/config behavior.                           | Keep; covered by root `yarn test`.                                    |
...
| app-executor sidecar                |     3 |          662 | `packages/app-executor/bin/*.test.mts`                                                                                                                  | Worker code runner, require root, executor config.                                                   | Keep; covered by root `yarn test`.                                               |
