...
In **Rivet settings** > **UI**, you can choose a built-in theme or choose **Custom** and pick the primary theme color. Under **Canvas**, you can change the canvas color and choose the canvas background pattern. **Theme** uses the current theme's dark canvas surface, **Grey-blue** uses the fixed `#282C34` background, and **Custom** lets you pick your own canvas color.
