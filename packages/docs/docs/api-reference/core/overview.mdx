...
`@valerypopoff/rivet2-core` is the shared runtime foundation for Rivet 2.0. It contains the graph/project data model, node definitions, execution engine, plugin contracts, serialization helpers, and provider/runtime abstractions used by the app, Node package, CLI, app executor, and Trivet.
