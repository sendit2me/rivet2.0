  ...
  nodeReference: [
    ...
    'node-reference/all-nodes',
    {
      ...
      items: [
        ...
        'node-reference/text',
        'node-reference/to-markdown-table',
    ...
    },
    {
      ...
      items: [
        ...
        'node-reference/js-filter',
        'node-reference/js-map',
        'node-reference/pop',
    ...
    },
    {
      ...
      items: [
        ...
        'node-reference/list-graphs',
        'node-reference/play-audio',
        'node-reference/read-all-files',
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: false,
      items: ['node-reference/chat-loop'],
    },
    {
      type: 'category',
      label: 'Advanced',
