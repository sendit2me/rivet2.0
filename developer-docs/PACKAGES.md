...
- Release-download actions should route to the site's `/download` page rather than direct GitHub release asset URLs, because the docs page owns the current official/developer release channel presentation
