...
- GitHub Pages docs deployment at `/rivet2.0/`, with Docusaurus docs at the site root and a top-right `/download` page that reads developer release metadata generated by the develop-branch Windows workflow
